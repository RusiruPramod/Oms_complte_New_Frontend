            ...
            if (selectedOrder) {
              const csv = [
                ...
                [
                  ...
                  selectedOrder.product_name || selectedOrder.product || 'N/A',
              ...
              const a = document.createElement('a');
              a.href = url;
              a.download = `order-${selectedOrder.id}-${new Date().toISOString().split('T')[0]}.csv`;
              a.click();
              window.URL.revokeObjectURL(url);

              toast({
                title: 'Success',
                description: 'Order downloaded successfully',
              });
            }
          }}
        />
...
export default CourierReturnOrders;
